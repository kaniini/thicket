defmodule Thicket.RenderingTest do
  ...
  test "preserves safe inline presentation and details while rejecting executable CSS" do
    source =
      "<details open><summary>look</summary><div style=\"display:flex;color:red\">ok</div><p style=\"background:url(javascript:x)\">bad</p></details>"
  ...
  test "comment Markdown does not admit custom HTML or style" do
    assert {:ok, html, 1} =
             Rendering.render_comment("**safe** <span style=\"position:fixed\">no</span>")
