defmodule Thicket.Identity.Scope do
  @moduledoc """
  Defines the scope of the caller to be used throughout the app.

  The `Thicket.Identity.Scope` allows public interfaces to receive
  ...
  defstruct user: nil, channel: nil
  ...
  """
  def for_user(%User{} = user, %Channel{} = channel) do
