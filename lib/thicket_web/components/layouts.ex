defmodule ThicketWeb.Layouts do
  @moduledoc """
  ...
  def app(assigns) do
    ~H"""
    <header class="flex items-center px-4 py-4 sm:px-6 lg:px-8">
      <div class="flex-1">
        <a href="/" class="flex-1 flex w-fit items-center gap-2">
          <span class="text-xl font-black tracking-tight text-emerald-900">Thicket</span>
        </a>
      </div>
      <div class="flex-none">
